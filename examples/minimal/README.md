...
The smallest valid call to this module: one action group with a single email receiver, common
alert schema on by default. The environment comes from the Terraform workspace
...
| Name | Description |
|------|-------------|
| <a name="output_action_group_ids"></a> [action\_group\_ids](#output\_action\_group\_ids) | Map of action group name to resource id. |
<!-- END_TF_DOCS -->
